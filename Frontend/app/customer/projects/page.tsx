...
import { Plus, Search, Eye, MessageSquare, Calendar, Edit, Trash2, Archive, Star, Clock, Loader2 } from "lucide-react"
...
export default function CustomerProjectsPage() {
  ...
  const filteredProjects = projects.filter((project) => {
    const matchesSearch =
      ...
      (project.provider?.name && project.provider.name.toLowerCase().includes(searchQuery.toLowerCase())) ||
...
const handleSaveProject = async () => {
  ...
  try {
    ...
    const payload: any = {
      ...
      priority: editingProject.priority?.toLowerCase?.() || editingProject.priority,
    };

    // If you show separate min/max in your dialog later, include them here:
    if (Number.isFinite(editingProject.budgetMin) && Number.isFinite(editingProject.budgetMax)) {
    ...
    const { project: updated } = await updateCompanyProject(editingProject.id, payload);
    ...
    toast({
      title: "Update failed",
      description: err instanceof Error ? err.message : "Could not update project",
      variant: "destructive",
    });
  }
};
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="MOBILE_APP_DEVELOPMENT">Mobile Development</SelectItem>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <Avatar className="w-8 h-8">
                        <AvatarImage src={project.provider?.avatar || "/placeholder.svg"} />
                        <AvatarFallback>
                          {project.provider?.name ? project.provider.name.charAt(0) : project.type.charAt(0)}
                        </AvatarFallback>
                      </Avatar>
                      <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{project.timeline || "Not specified"}</p>
                      </div>
                    </div>
                    ...
                    {project.type === "Project" && project.status === "COMPLETED" && (
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => router.push(`/customer/messages?project=${project.id}`)}
                      >
                    ...
                    <div key={project.id} className="p-6 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-1">
                              ...
                              {(project.priority === "High" || project.priority === "high") && <Badge variant="destructive">Urgent</Badge>}
                            </div>
                        ...
                        <div className="flex items-center space-x-6">
                          ...
                          <div className="flex gap-2">
                            <Button size="sm" onClick={() => router.push(`/customer/projects/${project.id}`)}>
                              <Eye className="w-4 h-4 mr-2" />
                              View
                            </Button>
                            <Button
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setEditingProject({ ...editingProject, budget: Number.parseInt(e.target.value) })
                      }
                    />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => setEditingProject({ ...editingProject, isUrgent: e.target.checked })}
                    className="rounded"
                  />
