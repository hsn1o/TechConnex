                ...
                <div className="space-y-4">
                  {loadingOpportunities ? (
                    ...
                    recommendedOpportunities.map((opportunity: any) => (
                      <div
                        key={opportunity.id}
                        className="group relative p-5 border-2 border-gray-200 rounded-xl hover:border-blue-400 hover:shadow-lg transition-all duration-300 bg-white"
                      >
                        {/* AI Badge Indicator */}
                        ...
                        <div className="flex items-start justify-between mb-3 pr-20">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2 flex-wrap">
                              <h4 className="font-semibold text-gray-900 group-hover:text-blue-700 transition-colors text-lg">
                                {opportunity.title}
                              </h4>
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-gray-200 group-hover:border-blue-200 transition-colors">
                          <div className="flex items-center gap-4 text-xs text-gray-600">
                            ...
                            {opportunity.proposalCount !== undefined && (
                              <span>{opportunity.proposalCount} proposal{opportunity.proposalCount !== 1 ? 's' : ''}</span>
                            )}
                          </div>
                          <Link href={`/provider/opportunities/${opportunity.id}`}>
                            <Button 
                              size="sm" 
                              className="group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-md"
                            >
